 ...
 *
 * @component
 * @param {Object} props - The props for preset.
 * @param {Object} props.preset - The preset object to display.
 * @param {Function} props.onClick - The function to run when clicked.
 * @param {string} props.selectedPreset - Stores the name of the currently highlighted preset.
 *
 * @example
 * return (
 *  <Preset
